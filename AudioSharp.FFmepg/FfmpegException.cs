...
using AudioSharp.Ffmpeg.Interops;
...
namespace AudioSharp.Ffmpeg
{
    ...
    public class FfmpegException : Exception
    {
        ...
        /// <exception cref="AudioSharp.Ffmpeg.FfmpegException"><see cref="FfmpegException"/> with some details (including the <paramref name="errorCode"/> and the <paramref name="function"/>).</exception>
