...
namespace AudioSharp.Codecs.AIFF
{
    /// <summary>
    ...
    public class AiffReader : IWaveSource
    {
        ...
        /// <exception cref="AudioSharp.Codecs.AIFF.AiffException">
        ///     No COMM Chunk found.
        ///     or
        ///     No SSND Chunk found.
        ///     or
        ...
        /// <exception cref="AudioSharp.Codecs.AIFF.AiffException">Unexpected error. Not supported bps.</exception>
