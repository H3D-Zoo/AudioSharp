...
namespace AudioSharp.CoreAudioAPI
{
    ...
    public class AudioSessionChannelVolumeChangedEventArgs : AudioSessionEventContextEventArgs
    {
        ...
        /// If the session submix contains n channels, the channels are numbered from 0 to n?1. If more than one channel might have changed, the value of ChangedChannel is (DWORD)(?).
        /// </summary>
