...
namespace AudioSharp.DMO
{
    ...
    public class MediaObject : ComObject
    {
        ...
        public static unsafe extern void MediaObjectProcessOutput(void *ptr, DmoOutputDataBuffer.DMO_OUTPUT_DATA_BUFFER buffer);
...
namespace AudioSharp.DMO.MONO
{
    public class MediaObject : IDisposable
    {
        ...
        internal MediaObject(IntPtr ptr, bool observe = false)
        {
            nativeptr = ptr;    
            hold = !observe;
        }
