...
namespace AudioSharp
{
    ...
    public static class FluentExtensions
    {
        ...
        ///     Note: If the <paramref name="input" /> has only one channel, the <see cref="ToStereo(AudioSharp.IWaveSource)" />
        ...
        ///     <see cref="ToStereo(AudioSharp.ISampleSource)" /> extension has to convert the <paramref name="input" /> to a
        ...
        ///     Note: If the <paramref name="input" /> has two channels, the <see cref="ToMono(AudioSharp.IWaveSource)" /> extension
        ...
        ///     Note: If the <paramref name="input" /> has only one channel, the <see cref="ToMono(AudioSharp.ISampleSource)" />
