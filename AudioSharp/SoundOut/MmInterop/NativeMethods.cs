...
namespace AudioSharp.SoundOut.MMInterop
{
    ...
    internal static class NativeMethods
    {
        ...
        [DllImport("winmm.dll")]
        public static extern MmResult waveInGetDevCaps(IntPtr deviceID, out AudioSharp.SoundIn.WaveInCaps waveInCaps, uint cbWaveInCaps);
