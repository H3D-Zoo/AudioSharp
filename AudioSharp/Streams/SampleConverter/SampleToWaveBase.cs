...
namespace AudioSharp.Streams.SampleConverter
{
    /// <summary>
    ...
    public abstract class SampleToWaveBase : IWaveSource
    {
        ...
        /// <param name="bits">The <see cref="AudioSharp.WaveFormat.BitsPerSample"/> of the Output-<see cref="WaveFormat"/>.</param>
        /// <param name="encoding">The <see cref="AudioSharp.WaveFormat.WaveFormatTag"/> of the Output-<see cref="WaveFormat"/>.</param>
        ...
        /// <summary>
        ///     Gets the <see cref="AudioSharp.WaveFormat"/> of the output waveform-audio data.
        /// </summary>
