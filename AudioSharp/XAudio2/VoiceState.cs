...
namespace AudioSharp.XAudio2
{
    ...
    public struct VoiceState
    {
        ...
        ///     <see cref="XAudio2SourceVoice.GetState(AudioSharp.XAudio2.GetVoiceStateFlags)" />,
        ///     this member won't be calculated, and its value is unspecified on return from
        ///     <see cref="XAudio2SourceVoice.GetState(AudioSharp.XAudio2.GetVoiceStateFlags)" />.
        ///     <see cref="XAudio2SourceVoice.GetState(AudioSharp.XAudio2.GetVoiceStateFlags)" /> takes about one-third as much time to
