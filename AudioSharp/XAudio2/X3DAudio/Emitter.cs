...
namespace AudioSharp.XAudio2.X3DAudio
{
    /// <summary>
    ...
    public class Emitter
    {
        ...
        /// <summary>
        /// Gets or sets the LFE roll-off distance curve, or NULL to use default curve: [0.0f, <see cref="CurveDistanceScaler" /> ?.0f], [<see cref="CurveDistanceScaler" /> ?.0f, 0.0f]. A NULL value for <see cref="LowFrequencyEffectCurve"/> specifies a default curve that conforms to the inverse square law with distances &lt;= <see cref="CurveDistanceScaler" /> clamped to no attenuation. <see cref="VolumeCurve" /> and <see cref="LowFrequencyEffectCurve"/> are independent of each other. <see cref="LowFrequencyEffectCurve"/> does not affect non LFE channel volume.
        /// </summary>
