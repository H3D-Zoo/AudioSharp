...
namespace AudioSharp.XAudio2
{
    ...
    public class XAudio2Voice : ComObject
    {
        ...
        /// <summary>
        ///     Gets the <see cref="AudioSharp.XAudio2.VoiceDetails" /> of the <see cref="XAudio2Voice" />.
        ///     These details include information about the number of input channels, the sample rate and the
        ///     <see cref="AudioSharp.XAudio2.VoiceFlags" />.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the <see cref="AudioSharp.XAudio2.FilterParameters" /> of the <see cref="XAudio2Voice" />.
        /// </summary>
        ...
        {
            return LocalInterop.Calli(UnsafeBasePtr, effectIndex, operationSet, ((void**) (*(void**) UnsafeBasePtr))[3]);
        }
            ...
            int destinationChannels, float[] levelMatrix, int operationSet)
        {
            ...
            {
                return LocalInterop.Calli(UnsafeBasePtr, pVoice.ToPointer(), sourceChannels, destinationChannels, p,
