...
// ReSharper disable once InconsistentNaming
    public class XAudio2_7 : XAudio2
    {
        ...
        {
            return LocalInterop.Calli(UnsafeBasePtr, flags, processor, ((void**) (*(void**) UnsafeBasePtr))[5]);
        }
        ...
        public override unsafe int RegisterForCallbacksNative(IXAudio2EngineCallback callback)
        {
            ...
            try
            {
                return LocalInterop.Calli(UnsafeBasePtr, ptr.ToPointer(), ((void**) (*(void**) UnsafeBasePtr))[6]);
            }
            finally
            {
                if (ptr != IntPtr.Zero)
        ...
        public override unsafe void UnregisterForCallbacks(IXAudio2EngineCallback callback)
        {
            ...
            try
            {
                LocalInterop.Calli(UnsafeBasePtr, (void*) ptr, ((void**) (*(void**) UnsafeBasePtr))[7]);
            }
            finally
            {
                if (ptr != IntPtr.Zero)
