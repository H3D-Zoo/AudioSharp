...
namespace CSCore.DirectSound
{
    ...
    [Flags]
    public enum DirectSoundPlayFlags
    {
        /// <summary>
        /// None
        /// </summary>
        ...
        Looping = 0x00000001,
        /// <summary>
        /// Play this voice in a hardware buffer only. If the hardware has no available voices and no voice management flags are set, the call to <see cref="DirectSoundBuffer.Play(DirectSoundPlayFlags)"/> fails. This flag cannot be combined with <see cref="LocSoftware"/>.
        /// </summary>
