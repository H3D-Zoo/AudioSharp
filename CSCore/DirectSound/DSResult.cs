namespace CSCore.DirectSound
{
    ...
    public enum DSResult
    {
        ...
        /// <summary>
        /// The buffer control (volume, pan, and so on) requested by the caller is not available. Controls must be specified when the buffer is created, using the <see cref="BufferDescription.Flags"/> member of <see cref="BufferDescription"/>.
        /// </summary>
        ...
        /// <summary>
        /// A cooperative level of <see cref="DirectSoundCooperativeLevel.Priority"/> or higher is required.
        /// </summary>
